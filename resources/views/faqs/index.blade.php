                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-white">
                                    <a class="py-2 hover:underline cursor-pointer hover:font-bold">Questão PT</a>
                                </th>
                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">
                                    <a class="py-2 hover:underline cursor-pointer hover:font-bold">Resposta PT</a>
                                </th>
                            ...
                            @forelse($faqs as $faq)
                                <tr>
                                    <td class="whitespace-wrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{$faq->question_pt}}</td>
                                    <td class="whitespace-wrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{$faq->answer_pt}}</td>
                                    <td class="w-36">
                                            ...
                                            <div class="flex">
                                                ...
                                                @if(auth()->user()->hasRole('admin'))
                                                    <div x-data="{ show: false }" class="mr-2">
                                                        ...
                                                        <x-confirmation-modal :model="$faq"/>
                                                    </div>
                                                @endif
                                            </div>
                                        @endif
