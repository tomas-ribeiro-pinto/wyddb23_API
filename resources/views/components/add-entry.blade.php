<x-add-modal>
    <x-slot name="slot">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
                <label class="block text-sm font-medium leading-6 text-gray-900">Descrição PT</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                <label class="block text-sm font-medium leading-6 text-gray-900">Descrição EN</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                <label class="block text-sm font-medium leading-6 text-gray-900">Início</span></label>
                <div class="mt-2">
