    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden">
                <div @if($errors->any()) x-data='{ show: true }' @else x-data='{ show: false }' @endif class="sm:px-6 lg:px-8 mb-8">
                                ...
                                <tr>
                                    ...
                                    <td class="w-36">
                                        @if(!auth()->user()->hasRole('notifier'))
                                            <div class="flex">
                                                <div @if($errors->any()) x-data='{ show: true }' @else x-data='{ show: false }' @endif class="mr-2">
                                                ...
                                                @if(auth()->user()->hasRole('admin'))
                                                    <div x-data="{ show: false }" class="mr-2">
                                                        ...
                                                        <x-confirmation-modal :entry="$entry"/>
                                                    </div>
                                                @endif
                                            </div>
                                        @endif
