    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 sm:px-6 lg:px-8">
                ...
                <h2 class="text-2xl font-bold">Horários <span class="font-semibold text-2xl text-white leading-tight p-2 bg-orange-600 rounded-2xl">SYM Day</span></h2>
            </div>
